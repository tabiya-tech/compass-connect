...
def main():
    ...
    backend_service_cfg = BackendServiceConfig(
        ...
        jobs_mongodb_uri=getenv("JOBS_MONGODB_URI", True),
        jobs_database_name=getenv("JOBS_DATABASE_NAME"),
        jobs_collection_name=getenv("JOBS_COLLECTION_NAME"),
        vertex_api_embeddings_region=getenv("VERTEX_API_EMBEDDINGS_REGION", True),
        vertex_api_gen_ai_region=getenv("VERTEX_API_GEN_AI_REGION", True),
