...
def add_analytics_routes(app: FastAPI, auth: Authentication):
    ...
    # Reach, module, job seekers and demographics analytics are server-to-server (api-key auth), not admin-JWT like the routes above.
    ...
    add_demographics_routes(analytics_router)
