...
Run `python evaluation_tests/evaluation_metrics.py --help` to see the available options.
...
- **`test_summary.csv`** - Aggregated summary (generated by `evaluation_metrics.py`)
...
After running `python evaluation_tests/evaluation_metrics.py`, `test_summary.csv` provides:
