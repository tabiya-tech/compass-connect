...
export enum EnvVariables {
  ...
  FRONTEND_SENSITIVE_DATA_FIELDS = "FRONTEND_SENSITIVE_DATA_FIELDS",
...
export const getSensitiveDataFields = () => {
  return getEnv(EnvVariables.FRONTEND_SENSITIVE_DATA_FIELDS);
};
